...
const easyAssign = require('@easy-webpack/assign');
...
const baseConfig = {
  ...
  plugins:[
    new CopyWebpackPlugin([
      { from: 'src/configuration/settings.json', to: 'configuration/settings.json' },
      { from: 'web.config', to: 'web.config' }
    ])]
}
require('@easy-webpack/config-common-chunks-simple')
({appChunkName: 'materialize', firstChunk: 'materialize'})


require('@easy-webpack/config-common-chunks-simple')
({appChunkName: 'aurelia-materialize-bridge', firstChunk: 'aurelia-materialize-bridge'})
  ...
  case 'production':
    config = generateConfig(
      ...
      require('@easy-webpack/config-uglify')
        ({debug: false,exclude:['materialize']})
    );
    break;
...
config.resolve.alias = {
  'Promise':path.resolve(path.join(__dirname, 'node_modules', 'bluebird'))
};
